 ...
 * e2e/playwright/tests/feature-flags/dev-supplied-attributes.spec.ts. Only the
 * framework wrapper differs — the demo route, testids, and assertions are
 * identical.
 *
 * Exercises the path:
 ...
 *
 * Note: the demo reaches for the raw instance via getBridgeFlagsInstance()
 * because that's the only API surface that takes the per-call attributes
 * argument. This test therefore exercises the auth-core SDK plumbing wired into
 * a Next.js app.
 */
