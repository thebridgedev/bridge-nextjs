...
import { realtimeBadgeView } from './realtime-dev-badge';
import { _setRealtimeStatusDetail, normalizeRealtimeStatus, realtimeStatusDetail } from './realtime-status';
...
function currentDetail(): WithHint {
  ...
  realtimeStatusDetail.subscribe((v) => {
    value = v;
  })();
