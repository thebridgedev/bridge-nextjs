 ...
 * Runs against the auth-core this workspace installs (0.7.0-beta.0), which
 * predates the `ORIGIN_NOT_ALLOWED` code — i.e. the plain-HttpError path older
 * apps hit.
 */
import { HttpError, createTranslator, en } from '@nebulr-group/bridge-auth-core';
import { _resetOriginReports, authErrorMessage, isOriginNotAllowed } from './auth-error';
import {
  ALLOWED_ORIGINS_ADMIN_PATH,
  ORIGIN_NOT_ALLOWED_DOCS_URL,
} from '../../../../shared/allowed-origins';
