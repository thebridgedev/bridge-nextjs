 ...
 *
 * Mirrors bridge-svelte's `shared/allowed-origins.ts`. Not imported from
 * auth-core, which exports the same constants only from TBP-669 on — an app on
 * an older auth-core in the peer range must still build.
 */
